...
def main(args):
    ...
    for epoch in range(start_epoch, args.num_epochs):
        ...
        for i, sample_batched in enumerate(train_loader):
            ...
            constra_loss = contra_func(fea_x1_x1, fea_x1_x2, contrast_label)
            ...
            if i % args.print_freq == args.print_freq - 1:
                print("Epoch:{:d}, mini-batch:{:d}, lr={:.5f}, binary_loss={:.4f}, constra_loss={:.4f}, adv_loss={:.4f}, Loss={:.4f}".format(epoch + 1, i + 1, lr, binary_loss_record.avg, constra_loss_record.avg, adv_loss_record.avg, loss_record.avg))
            scheduler.step()
